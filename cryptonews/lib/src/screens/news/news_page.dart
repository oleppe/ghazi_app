                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            var parsedData = Uri.encodeComponent(
                                'https://cryptonewsfun.page.link/?link=https://cryptonewsfun.page.link/zXbp/?id=${widget.news.id}&apn=com.ghazi.cryptonews&afl=https://play.google.com/store/apps/details?id=com.ghazi.cryptonews');
                            String short =
                                await ApiSdk.generateShortLink(parsedData);
                            context.loaderOverlay.hide();
                            Share.share(widget.news.name + " " + short);
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
