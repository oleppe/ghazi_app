...
class DeFiPage extends StatefulWidget {
  ...
  DeFiPage(this.category, {Key? key}) : super(key: key);
...
class _DeFiPageState extends State<DeFiPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FutureBuilder<List<News>>(
          future: newsContext.fetchDefiNews(widget.category, true),
  ...
  void _onRefresh() async {
    news =
        await newsContext.fetchDefiNews(widget.category, false, refresh: true);
    setState(() {
      isLoadMore = true;
      pageCount = news.length;
  ...
  void _onLoading() async {
    ...
    List<News> loadNews =
        await newsContext.fetchDefiNews(widget.category, false);
