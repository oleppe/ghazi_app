...
class NFTPage extends StatefulWidget {
  ...
  NFTPage(this.category, {Key? key}) : super(key: key);
...
class _NFTPageState extends State<NFTPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FutureBuilder<List<News>>(
          future: newsContext.fetchNftNews(widget.category, true),
  ...
  void _onRefresh() async {
    news =
        await newsContext.fetchNftNews(widget.category, false, refresh: true);
    setState(() {
      isLoadMore = true;
      pageCount = news.length;
  ...
  void _onLoading() async {
    ...
    List<News> loadNews =
        await newsContext.fetchNftNews(widget.category, false);
